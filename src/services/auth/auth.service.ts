...
export const authApi = createApi({
  ...
  tagTypes: ["User", "Category", "Course", "Lesson", "TryItYourself", "Language", "ExerciseSession", "Exercise", "AdminExercise", "Discussion", "Reply", "Problem", "TestCase", "Tag", "Submission", "AiConversation", "AdminUser", "DashboardStats", "DailyActivity", "UserGrowth", "CategoryDistribution", "SubmissionStatus", "ProblemDifficulty"],
  endpoints: (builder) => ({
