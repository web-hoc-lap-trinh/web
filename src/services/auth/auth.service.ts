...
export const authApi = createApi({
  ...
  tagTypes: ["User", "Category", "Course", "Lesson", "TryItYourself", "Language", "ExerciseSession", "Exercise", "AdminExercise", "Discussion", "Reply", "Problem", "TestCase", "Tag", "Submission", "AiConversation", "AdminUser"], 
  endpoints: (builder) => ({
