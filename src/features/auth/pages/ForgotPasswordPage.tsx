            ...
            <main className="min-h-screen w-full bg-[#051311] flex items-center justify-center px-4 relative overflow-hidden pt-20">
                ...
                <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 sm:p-10 relative z-10">
                    <div className="flex flex-col items-center text-center space-y-4 mb-8">
                        <div className="w-16 h-16 bg-linear-to-tr from-emerald-500 to-teal-400 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/30">
                    ...
                    <div className="space-y-6">
                        ...
                        <Button
                            className="w-full h-12 text-base font-semibold border-0 bg-linear-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 shadow-lg"
                            type="primary"
