...
const ChallengePage = () => {
  const { data: dailyProblems, isLoading, isError, refetch } = useGetDailyChallengeQuery();
    ...
    >
      <div className="min-h-screen bg-[#030e0c] pb-16 pt-20 font-sans text-white">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="mb-8">
             <DailyChallengeHero 
                completedCount={0} // TODO: Lấy từ API user status nếu có
                total={dailyProblems?.length || 5} 
             />
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div className="space-y-3">
                  {dailyProblems.map((problem) => (
                    <DailyProblemItem 
                        ...
                        problem={problem}
                        isSolved={false} // TODO: Logic check solved
                    />
                  ))}
                </div>
              )}
            ...
            <div className="lg:col-span-4 space-y-6">
               ...
               <div className="rounded-3xl border border-emerald-500/20 bg-linear-to-br from-emerald-900/20 to-[#0a1916] p-6 text-center">
                  ...
                  <div className="text-3xl font-extrabold text-white">0 Ngày</div>
